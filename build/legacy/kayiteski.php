...
if ($nedir=="form")
{
	...
	echo "<h2>kayit ortamlari</h2>$hata";
	echo "<form method=\"post\" action=\"kayit.php?nedir=kayit\" name=\"kayit\">";
	echo "<h4>kullanici adi</h4><input type=\"text\" name=\"kullanici\" size=\"35\" maxlength=\"50\"><br><br>";
	...
	echo "<h4>isim nedir?</h4><input type=\"text\" name=\"yazarisim\" size=\"35\" maxlength=\"250\"><br><br>";
	echo "<h4>emayil adresi</h4><input type=\"text\" name=\"email\" size=\"35\" maxlength=\"100\"><br><br>";
	echo "gercek emayil adresi girmezsen onay monay yok sana.<br><br>";
	...
	echo "</select><br><br>";
	menuyap("tekbuton", "ortamlara akalim haci", "#", "document.kayit.submit();");
	echo "<br></form>";
...
elseif ($nedir=="degistir")
{
	...
	if ($sifredegistir=="1")
	{
		$sql = "update ob_uyeler set isim = '$yazarisim', kulisim = '$kullanici', sifre = '".md5($sifre)."', email = '$email', tema = '$temaform', rumuz = '$rumuz' where id = '$id'";
	}
	else
	{
		$sql = "update ob_uyeler set isim = '$yazarisim', kulisim = '$kullanici', email = '$email', tema = '$temaform', rumuz = '$rumuz' where id = '$id'";
